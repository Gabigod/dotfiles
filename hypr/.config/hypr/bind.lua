...
hl.bind(mainMod .. "+ SHIFT + S", hl.dsp.exec_cmd("hyprshot -m window -o ~/Imagens/hyprshot/"))
hl.bind("PRINT", hl.dsp.exec_cmd("hyprshot -m region -o ~/Imagens/hyprshot/"))
hl.bind(mainMod .. " + M", hl.dsp.exec_cmd("sh -c 'spotify & sleep 3 && playerctl -p spotify play'"))
...
-- hl.bind(mainMod .. " + T", hl.dsp.exec_cmd("~/.local/bin/themectl"))

-- -- Redimensionamento com teclas do Vim (H, J, K, L)
...
-- Redimensionamento com as setas do teclado
